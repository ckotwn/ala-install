...
BEGIN
    ...
    COPY
        ...
        select
            ...
            regexp_replace(original_filename, ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "identifier",
            regexp_replace(audience,          ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "audience",
            regexp_replace(contributor,       ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "contributor",
            regexp_replace(created,           ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "created",
            regexp_replace(creator,           ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "creator",
            regexp_replace(description,       ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "description",
            regexp_replace(mime_type,         ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "format",
            regexp_replace(license,           ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "license",
            regexp_replace(publisher,         ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "publisher",
            regexp_replace(dc_references,     ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "references",
            regexp_replace(rights_holder,     ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "rightsHolder",
            regexp_replace(source,            ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "source",
            regexp_replace(title,             ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "title",
            regexp_replace(type,              ''\\P{Cc}\\P{Cn}\\P{Cs}\\P{Cf}'',  '''', ''g'')  AS "type",
            is_duplicate_of_id
            from image i
